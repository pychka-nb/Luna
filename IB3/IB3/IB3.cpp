...
// IB3.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CIB3App, CWinApp)
...
// Единственный объект CIB3App

CIB3App theApp;


// Инициализация CIB3App

BOOL CIB3App::InitInstance()
{
